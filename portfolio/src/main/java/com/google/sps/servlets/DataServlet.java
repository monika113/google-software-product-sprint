...
public class DataServlet extends HttpServlet {
  ...
  public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
    ...
    for (Entity entity : results.asIterable()) {
      ...
      String imageLables = (String) entity.getProperty("imageLables");
      long timestamp = (long) entity.getProperty("timestamp");

      Comment comment = new Comment(userName, userEmail, text, imageUrl, imageLables, timestamp);
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
    ...
    String DisplayImageLables = "";
    for (EntityAnnotation label : imageLabels) {
      DisplayImageLables += label.getDescription() + ";    ";
    }
    //comments.add(text);
    ...
    commentEntity.setProperty("imageLables", DisplayImageLables);
